      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{url('/admin/edit-coupon/'.$couponDetails->id)}}" name="edit_coupon" id="edit_coupon" autocomplete="off"> {{ csrf_field() }}

              <div class = "control-group">
                <label class="control-label">Coupon Code</label>
                <div class="controls">
                  <input type="text" value="{{$couponDetails->coupon_code}}" name="coupon_code" id="coupon_code" minlength="5" maxlength="15" required autocomplete="off">
                </div>
              </div>
